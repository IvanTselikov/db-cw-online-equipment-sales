...
-- мен€ем тип столбца characteristicValue таблицы ProductCharacteristics с nvarchar на sql_variant
ALTER TABLE ProductCharacteristics ALTER COLUMN characteristicValue SQL_VARIANT NOT NULL;
